...
struct AccountSettings {
	...
	AccountSettings();
	void Init();
	bool AccountLoad(int id, Account *account, CString filename = _T(""));
	void AccountSave(int id, Account *account, CString filename = _T(""));
	void AccountDelete(int id);
	void SettingsLoad(CString filename = _T(""));
	void SettingsSave(CString filename = _T(""));
    void GlobalSave(CString filename = _T(""));
};
...
void ShortcutDecode(const CString& str, Shortcut* pShortcut, bool noDefault = false);
void ShortcutsLoad(CString filename = _T(""));
void ShortcutsSave(CString filename = _T(""));
